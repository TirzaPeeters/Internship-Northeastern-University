...
for field_output = 1:length(all_fieldoutput)  
    ...
    for point = 1:length(point_names)
        ...
        for m = 1:length(mesh_names)
            plot(time_total{m}, T_total{m}, 'LineWidth', 1.5)
        end
        ...
        savefig("C:\Users\Tirza\Documents\My codes for postprocessing\Output plots meshes\" + all_fieldoutput(field_output) + "_point_" + P + "_meshcomparison.fig");
        saveas(gcf, "C:\Users\Tirza\Documents\My codes for postprocessing\Mesh plots bottom deposit\" + all_fieldoutput(field_output) + "_point_" + P + "_meshcomparison.png");
